...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 02, 2021 at 10:59 PM
...
INSERT INTO `equipment` (`id`, `name`, `category_id`, `availability`, `eqID`) VALUES
(23, 'Bose Pro F1', 40000, 1, 'BPF10'),
(24, 'Zoook Rocker Boombox', 40000, 2, 'ZRP00'),
(25, 'boAt Stone 1000', 40000, 1, 'BS100'),
(26, 'JBL SB110', 40000, 1, 'JS000'),
(27, 'Artis BT90', 40000, 2, 'AB000'),
(28, 'Tycon Power (UPS-DC1248-9)', 30000, 1, 'TP000'),
(29, 'ALLWEI Portable Power Station', 30000, 1, 'APPS0'),
(30, 'Goal Zero Yeti 200x', 30000, 2, 'GZY20'),
(31, 'EF ECOFLOW DELTA Max ', 30000, 1, 'EEDM0'),
(32, 'BLUETTI Portable Power Station', 30000, 2, 'BPPS0'),
(33, 'EF ECOFLOW RIVER Pro', 30000, 2, 'EERP0'),
(34, 'OPPSK Stage Light', 20000, 1, 'OSL00'),
(35, 'TSSS RGBW Pattern Stage Light', 20000, 1, 'TRPSL'),
(36, 'TENKOO LED Par Stage Light', 20000, 2, 'TLPSL'),
(37, 'KOOT Stage Lights', 20000, 1, 'KSL00'),
(38, 'SAHAUHY Stage Lights', 20000, 2, 'SSL00'),
(39, 'BETOPPER Stage Lights', 20000, 1, 'BSL00'),
(40, 'LED Smoke Fog Machine', 10000, 1, 'LSFM0'),
(41, 'Portable 36Wide DJ Workstation', 10000, 1, 'PWDW0'),
(42, 'CC-500 Crowd Control Barricade', 10000, 2, 'CCCB0'),
(43, 'Concert Front Of Stage Barrier', 10000, 1, 'CFOSB'),
(44, 'Guardian Hinged Gate Barrier', 10000, 2, 'GHGB0'),
(45, 'Guardian 90º Angle Flex Corner', 10000, 1, 'GAFC0');
...
INSERT INTO `transaction` (`id`, `equiment_id`, `date`, `cost`, `customer_id`) VALUES
(1, 27, '2021-11-02', 1000, 5),
(2, 45, '2021-10-19', 2500.8, 6);
