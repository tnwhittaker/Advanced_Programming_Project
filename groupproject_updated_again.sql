...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 14, 2021 at 07:52 AM
...
INSERT INTO `transaction` (`id`, `equipment_id`, `date`, `customer_id`, `approve`) VALUES
(1, 27, '2021-11-02', 5, 0),
(2, 45, '2021-10-19', 6, 0),
(3, 27, '2021-11-08', 5, 0),
(4, 23, '2021-11-08', 5, 0),
(5, 40, '2021-11-05', 5, 0),
(6, 43, '2021-11-11', 15, 0),
(7, 45, '2021-11-17', 15, 0);
...
ALTER TABLE `transaction`
  ADD PRIMARY KEY (`id`),
  ADD KEY `transaction_equipemnt_id_foreign` (`equipment_id`),
...
ALTER TABLE `transaction`
  ...
  ADD CONSTRAINT `transaction_equipemnt_id_foreign` FOREIGN KEY (`equipment_id`) REFERENCES `equipment` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
